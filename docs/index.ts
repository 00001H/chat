...
const hist = document.getElementById("hist") as HTMLDivElement;
const msgbox = document.getElementById("msgbox") as HTMLInputElement;
function create_message(sender: string,content: string): HTMLParagraphElement{
...
connection.addEventListener("message",(e: MessageEvent<ArrayBuffer>) => {
